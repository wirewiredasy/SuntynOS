// Modern JavaScript for business-name-generator
class BusinessnamegeneratorTool {
    constructor() {
        this.files = [];
    ...
    async processFiles() {
        ...
        try {
            ...
            formData.append('tool_name', 'business-name-generator');
