// Modern JavaScript for vehicle-number-validator
class VehiclenumbervalidatorTool {
    constructor() {
        this.files = [];
    ...
    async processFiles() {
        ...
        try {
            ...
            formData.append('tool_name', 'vehicle-number-validator');
...
document.addEventListener('DOMContentLoaded', function() {
    new VehiclenumbervalidatorTool();
});
