// Modern JavaScript for driving-license-validator
class DrivinglicensevalidatorTool {
    constructor() {
        this.files = [];
    ...
    async processFiles() {
        ...
        try {
            ...
            formData.append('tool_name', 'driving-license-validator');
...
document.addEventListener('DOMContentLoaded', function() {
    new DrivinglicensevalidatorTool();
});
